...
<form class="form-signin" name="LoginForm" method="POST" action="controller" accept-charset="utf-8">
    ...
    <div>
        Нет аккаунта?
        <a href="${pageContext.request.contextPath}/controller?command=go-to&page=registration">Регистрация</a>
    </div>
</form>
